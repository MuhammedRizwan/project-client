...
import EmailInputs from "../Inputs/Inputs";
      ...
      <div className="w-full h-full flex flex-col md:flex-row">
        <div className="w-full md:w-1/2 bg-black py-6 flex md:flex-col justify-center items-center me-40">
          ...
          <div className="w-full py-10 flex justify-center items-center ms-16">
            <EmailInputs className="max-w-xs" />
            <div className="m-1 p-5 bg-orange-800 rounded-lg z-10">
        ...
        <div className="w-full md:w-1/2 py-10  ">
          ...
          <div className="grid grid-cols-3 gap-4 font-serif">
            <div className="hover:cursor-pointer">
              <h3 className="text-white hover:text-red-500 me-24">Home</h3>
            </div>
            <div className="hover:cursor-pointer">
              <h3 className="text-white hover:text-red-500 me-24">Packages</h3>
            </div>
            <div className="hover:cursor-pointer">
              <h3 className="text-white hover:text-red-500 me-24">Blog</h3>
            </div>
            <div className="hover:cursor-pointer">
              <h3 className="text-white hover:text-red-500 me-24">Contacts</h3>
            </div>
            <div className="hover:cursor-pointer">
              <h3 className="text-white hover:text-red-500 me-24">Booking</h3>
            </div>
          </div>

          <div className="py-10">
            <Button className="text-red-600">Login As Travel agent</Button>
          </div>
        </div>
      </div>
    </div>
