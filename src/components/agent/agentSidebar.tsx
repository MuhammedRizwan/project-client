        ...
        <ul className="space-y-4">
          ...
          <li
            className={`flex items-center ${
              pathname === "/agent/dashboard" ? "bg-gray-100" : "bg-white"
            } shadow-lg rounded-lg px-6 py-4 cursor-pointer`}
          >
            <Link href="/agent/dashboard" className="flex items-center w-full">
              <svg
          ...
          <li
            className={`flex items-center ${
              pathname === "/agent/travel-packages" ? "bg-gray-300" : "bg-white"
            } shadow-lg rounded-lg px-6 py-4 cursor-pointer`}
          >
            <Link
              href="/agent/travel-packages"
            ...
            >
              ...
              <span className="text-gray-700">Travel Pakages</span>
            </Link>
          </li>

          <li
            className={`flex items-center ${
              pathname === "/agent/bookings" ? "bg-gray-100" : "bg-white"
            } shadow-lg rounded-lg px-6 py-4 cursor-pointer`}
          >
            <Link href="/agent/bookings" className="flex items-center w-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
